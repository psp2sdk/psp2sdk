...
enum {
	//! Undefined error
	PSP2_AUDIO_IN_ERROR_FATAL		= 0x80260100,

	//! Bad value of port number
	PSP2_AUDIO_IN_ERROR_INVALID_PORT		= 0x80260101,

	//! Invalid sample length
	PSP2_AUDIO_IN_ERROR_INVALID_SIZE		= 0x80260102,

	//! Invalid sample frequency
	PSP2_AUDIO_IN_ERROR_INVALID_SAMPLE_FREQ	= 0x80260103,

	//! Invalid port type
	PSP2_AUDIO_IN_ERROR_INVALID_PORT_TYPE	= 0x80260104,

	//! Invalid pointer value
	PSP2_AUDIO_IN_ERROR_INVALID_POINTER	= 0x80260105,

	//! Invalid port param
	PSP2_AUDIO_IN_ERROR_INVALID_PORT_PARAM	= 0x80260106,

	//! Cannot open no ports
	PSP2_AUDIO_IN_ERROR_PORT_FULL		= 0x80260107,

	//! Not enough memory
	PSP2_AUDIO_IN_ERROR_OUT_OF_MEMORY	= 0x80260108,

	//! Port is not opened
	PSP2_AUDIO_IN_ERROR_NOT_OPENED		= 0x80260109,

	//! Tried to input while busy
	PSP2_AUDIO_IN_ERROR_BUSY			= 0x8026010A
};
