...
typedef enum SceRtcCheckValidError {
	PSP2_RTC_INVALID_YEAR	= -1,
	PSP2_RTC_INVALID_MONTH	= -2,
	PSP2_RTC_INVALID_DAY	= -3,
	PSP2_RTC_INVALID_HOUR	= -4,
	PSP2_RTC_INVALID_MINUTES	= -5,
	PSP2_RTC_INVALID_SECONDS	= -6,
	PSP2_RTC_INVALID_MICROSECONDS	= -7
