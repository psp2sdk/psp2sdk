...
enum {
	PSP2_CAMERA_ERROR_PARAM		        = 0x802e0000,
	PSP2_CAMERA_ERROR_ALREADY_INIT		= 0x802e0001,
	PSP2_CAMERA_ERROR_NOT_INIT		= 0x802e0002,
	PSP2_CAMERA_ERROR_ALREADY_OPEN		= 0x802e0003,
	PSP2_CAMERA_ERROR_NOT_OPEN		= 0x802e0004,
	PSP2_CAMERA_ERROR_ALREADY_START		= 0x802e0005,
	PSP2_CAMERA_ERROR_NOT_START		= 0x802e0006,
	PSP2_CAMERA_ERROR_FORMAT_UNKNOWN		= 0x802e0007,
	PSP2_CAMERA_ERROR_RESOLUTION_UNKNOWN	= 0x802e0008,
	PSP2_CAMERA_ERROR_BAD_FRAMERATE		= 0x802e0009,
	PSP2_CAMERA_ERROR_TIMEOUT		= 0x802e000a,
	PSP2_CAMERA_ERROR_EXCLUSIVE		= 0x802e000b,
	PSP2_CAMERA_ERROR_ATTRIBUTE_UNKNOWN	= 0x802e000c,
	PSP2_CAMERA_ERROR_MAX_PROCESS		= 0x802e000d,
	PSP2_CAMERA_ERROR_NOT_ACTIVE		= 0x802e000e,
	PSP2_CAMERA_ERROR_FATAL			= 0x802e00ff
};
