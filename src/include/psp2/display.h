...
enum {
	PSP2_DISPLAY_ERROR_OK			= 0,
	PSP2_DISPLAY_ERROR_INVALID_HEAD		= 0x80290000,
	PSP2_DISPLAY_ERROR_INVALID_VALUE		= 0x80290001,
	PSP2_DISPLAY_ERROR_INVALID_ADDR		= 0x80290002,
	PSP2_DISPLAY_ERROR_INVALID_PIXELFORMAT	= 0x80290003,
	PSP2_DISPLAY_ERROR_INVALID_PITCH		= 0x80290004,
	PSP2_DISPLAY_ERROR_INVALID_RESOLUTION	= 0x80290005,
	PSP2_DISPLAY_ERROR_INVALID_UPDATETIMING	= 0x80290006,
	PSP2_DISPLAY_ERROR_NO_FRAME_BUFFER	= 0x80290007,
	PSP2_DISPLAY_ERROR_NO_PIXEL_DATA		= 0x80290008
};
