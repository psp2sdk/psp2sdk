...
enum AudioOutPortType {
	PSP2_AUDIO_OUT_PORT_TYPE_MAIN	= 0, //!< Used for main audio output, freq must be set to 48000 Hz
	PSP2_AUDIO_OUT_PORT_TYPE_BGM	= 1, //!< Used for Background Music port
	PSP2_AUDIO_OUT_PORT_TYPE_VOICE	= 2  //!< Used for voice chat port
};
