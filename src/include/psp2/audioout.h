...
enum {
	PSP2_AUDIO_OUT_ERROR_NOT_OPENED		= 0x80260001,
	PSP2_AUDIO_OUT_ERROR_BUSY		= 0x80260002,
	PSP2_AUDIO_OUT_ERROR_INVALID_PORT	= 0x80260003,
	PSP2_AUDIO_OUT_ERROR_INVALID_POINTER	= 0x80260004,
	PSP2_AUDIO_OUT_ERROR_PORT_FULL		= 0x80260005,
	PSP2_AUDIO_OUT_ERROR_INVALID_SIZE	= 0x80260006,
	PSP2_AUDIO_OUT_ERROR_INVALID_FORMAT	= 0x80260007,
	PSP2_AUDIO_OUT_ERROR_INVALID_SAMPLE_FREQ	= 0x80260008,
	PSP2_AUDIO_OUT_ERROR_INVALID_VOLUME	= 0x80260009,
	PSP2_AUDIO_OUT_ERROR_INVALID_PORT_TYPE	= 0x8026000A,
	PSP2_AUDIO_OUT_ERROR_INVALID_FX_TYPE	= 0x8026000B,
	PSP2_AUDIO_OUT_ERROR_INVALID_CONF_TYPE	= 0x8026000C,
	PSP2_AUDIO_OUT_ERROR_OUT_OF_MEMORY	= 0x8026000D
};
