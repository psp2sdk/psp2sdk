...
enum {
	PSP2_APPUTIL_ERROR_PARAMETER			= 0x80100600,
	PSP2_APPUTIL_ERROR_NOT_INITIALIZED		= 0x80100601,
	PSP2_APPUTIL_ERROR_NO_MEMORY			= 0x80100602,
	PSP2_APPUTIL_ERROR_BUSY				= 0x80100603,
	PSP2_APPUTIL_ERROR_NOT_MOUNTED			= 0x80100604,
	PSP2_APPUTIL_ERROR_NO_PERMISSION			= 0x80100605,
	PSP2_APPUTIL_ERROR_APPEVENT_PARSE_INVALID_DATA	= 0x80100620,
	PSP2_APPUTIL_ERROR_SAVEDATA_SLOT_EXISTS		= 0x80100640,
	PSP2_APPUTIL_ERROR_SAVEDATA_SLOT_NOT_FOUND	= 0x80100641,
	PSP2_APPUTIL_ERROR_SAVEDATA_NO_SPACE_QUOTA	= 0x80100642,
	PSP2_APPUTIL_ERROR_SAVEDATA_NO_SPACE_FS		= 0x80100643,
	PSP2_APPUTIL_ERROR_PHOTO_DEVICE_NOT_FOUND	= 0x80100680,
};
