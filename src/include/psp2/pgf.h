...
enum {
	PSP2_FONT_ERROR_OUT_OF_MEMORY        = 0x80460001,
	PSP2_FONT_ERROR_INVALID_LIBID        = 0x80460002,
	PSP2_FONT_ERROR_INVALID_PARAMETER    = 0x80460003,
	PSP2_FONT_ERROR_HANDLER_OPEN_FAILED  = 0x80460005,
	PSP2_FONT_ERROR_TOO_MANY_OPEN_FONTS  = 0x80460009,
	PSP2_FONT_ERROR_INVALID_FONT_DATA    = 0x8046000a,
};
