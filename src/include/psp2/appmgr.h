...
enum {
	//! Busy
	PSP2_APPMGR_ERROR_BUSY			= 0x80802000,

	//! Invalid state
	PSP2_APPMGR_ERROR_STATE			= 0x80802013,

	//! NULL pointer
	PSP2_APPMGR_ERROR_NULL_POINTER		= 0x80802016,

	//!< Invalid param
	PSP2_APPMGR_ERROR_INVALID		= 0x8080201a,

	//!< Invalid self path
	PSP2_APPMGR_ERROR_INVALID_SELF_PATH	= 0x8080201e,

	//!< argv is too long
	PSP2_APPMGR_ERROR_TOO_LONG_ARGV		= 0x8080201d
};

enum {
	PSP2_APPMGR_SYSTEMEVENT_ON_RESUME		= 0x10000003,
	PSP2_APPMGR_SYSTEMEVENT_ON_STORE_PURCHASE	= 0x10000004,
	PSP2_APPMGR_SYSTEMEVENT_ON_NP_MESSAGE_ARRIVED	= 0x10000005,
	PSP2_APPMGR_SYSTEMEVENT_ON_STORE_REDEMPTION	= 0x10000006,
};

enum {
	PSP2_APPMGR_INFOBAR_VISIBILITY_INVISIBLE	= 0,
	PSP2_APPMGR_INFOBAR_VISIBILITY_VISIBLE	= 1
};

enum {
	PSP2_APPMGR_INFOBAR_COLOR_BLACK	= 0,
	PSP2_APPMGR_INFOBAR_COLOR_WHITE	= 1
};

enum {
	PSP2_APPMGR_INFOBAR_TRANSPARENCY_OPAQUE	= 0,
	PSP2_APPMGR_INFOBAR_TRANSPARENCY_TRANSLUCENT	= 1
};
...
#define PSP2_APPMGR_MAX_APP_NAME_LENGTH	(31)
