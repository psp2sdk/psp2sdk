...
enum {
	PSP2_SCREENSHOT_ERROR_INVALID_ARGUMENT		= 0x80102f01,
	PSP2_SCREENSHOT_ERROR_NO_MEMORY			= 0x80102f02,
	PSP2_SCREENSHOT_ERROR_FILE_NOT_FOUND		= 0x80102f03,
	PSP2_SCREENSHOT_ERROR_NOT_SUPPORTED_FORMAT	= 0x80102f04,
	PSP2_SCREENSHOT_ERROR_MEDIA_FULL			= 0x80102f05,
	PSP2_SCREENSHOT_ERROR_INTERNAL			= 0x80102f06
};

//! Max size of path strings (includes device name and NULL terminator)
#define PSP2_SCREENSHOT_MAX_FS_PATH		(1024)

//! Max length of photo title
#define PSP2_SCREENSHOT_MAX_PHOTO_TITLE_LEN	(64)

//! Max size of photo title (includes NULL terminater)
#define PSP2_SCREENSHOT_MAX_PHOTO_TITLE_SIZE (PSP2_SCREENSHOT_MAX_PHOTO_TITLE_LEN * 4)

//! Max length of game title
#define PSP2_SCREENSHOT_MAX_GAME_TITLE_LEN	(64)

//! Max size of game title (includes NUL terminator)
#define PSP2_SCREENSHOT_MAX_GAME_TITLE_SIZE	(PSP2_SCREENSHOT_MAX_GAME_TITLE_LEN * 4)

//! Max length of comment (description)
#define PSP2_SCREENSHOT_MAX_GAME_COMMENT_LEN	(128)

//! Max size of comment (description) (includes NUL terminator)
#define PSP2_SCREENSHOT_MAX_GAME_COMMENT_SIZE	(PSP2_SCREENSHOT_MAX_GAME_COMMENT_LEN * 4)
