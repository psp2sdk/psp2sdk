...
enum {
	PSP2_AUDIOENC_ERROR_API_FAIL		= 0x80860000,
	PSP2_AUDIOENC_ERROR_INVALID_TYPE		= 0x80860001,
	PSP2_AUDIOENC_ERROR_INVALID_INIT_PARAM	= 0x80860002,
	PSP2_AUDIOENC_ERROR_ALREADY_INITIALIZED	= 0x80860003,
	PSP2_AUDIOENC_ERROR_OUT_OF_MEMORY	= 0x80860004,
	PSP2_AUDIOENC_ERROR_NOT_INITIALIZED	= 0x80860005,
	PSP2_AUDIOENC_ERROR_A_HANDLE_IN_USE	= 0x80860006,
	PSP2_AUDIOENC_ERROR_ALL_HANDLES_IN_USE	= 0x80860007,
	PSP2_AUDIOENC_ERROR_INVALID_PTR		= 0x80860008,
	PSP2_AUDIOENC_ERROR_INVALID_HANDLE	= 0x80860009,
	PSP2_AUDIOENC_ERROR_NOT_HANDLE_IN_USE	= 0x8086000A,
	PSP2_AUDIOENC_ERROR_CH_SHORTAGE		= 0x8086000B,
	PSP2_AUDIOENC_ERROR_INVALID_WORD_LENGTH	= 0x8086000C,
	PSP2_AUDIOENC_ERROR_INVALID_SIZE		= 0x8086000D,
	PSP2_AUDIOENC_ERROR_INVALID_ALIGNMENT	= 0x8086000E
};

enum {
	PSP2_AUDIOENC_CELP_ERROR_INVALID_CONFIG	= 0x80861001,
};
